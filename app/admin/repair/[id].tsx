...
const styles = StyleSheet.create({
  container: { padding: spacing.lg, paddingTop: 60, backgroundColor: colors.background, minHeight: '100%' },
  center: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  header: { flexDirection: 'row', alignItems: 'center', marginBottom: spacing.xl },
  backBtn: { marginRight: spacing.md },
  title: { fontSize: 22, fontWeight: '700', color: colors.text },
  infoCard: { backgroundColor: colors.card, padding: spacing.md, borderRadius: borderRadius.lg, marginBottom: spacing.xl, ...shadows.sm },
  jobId: { fontSize: 14, color: colors.primary, fontWeight: '700', marginBottom: 4 },
  deviceInfo: { fontSize: 18, fontWeight: '600', color: colors.text, marginBottom: spacing.sm },
  issueLabel: { fontSize: 12, color: colors.textSecondary, marginBottom: 2 },
  issueText: { fontSize: 14, color: colors.text, fontStyle: 'italic' },
  sectionHeader: { fontSize: 18, fontWeight: '600', marginBottom: 12, color: colors.text },
  sectionTitle: { fontSize: 16, fontWeight: '600', color: colors.text, marginBottom: spacing.md },
  textArea: { backgroundColor: colors.card, borderRadius: borderRadius.lg, padding: spacing.md, height: 120, textAlignVertical: 'top', fontSize: 15, marginBottom: spacing.xl, ...shadows.sm },
  saveButton: { backgroundColor: colors.textSecondary, paddingVertical: 16, borderRadius: borderRadius.lg, alignItems: 'center', marginBottom: spacing.xxl },
  saveBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  lockedContainer: { alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.xl, gap: spacing.sm },
  lockedTitle: { fontSize: 18, fontWeight: '700', color: colors.textSecondary, marginTop: spacing.sm },
  lockedText: { fontSize: 14, color: colors.textSecondary, textAlign: 'center' },
  readOnlyNotesBox: { marginTop: spacing.lg, width: '100%', padding: spacing.md, backgroundColor: colors.card, borderRadius: borderRadius.md, borderWidth: 1, borderColor: colors.border }
});